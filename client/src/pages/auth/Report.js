                    ...
                    <div className="container-fluid">
                        <div className="page-title">
                            ...
                            <div className="d-flex align-items-center">
                                <div><h1 className="mb-0 h1-heading">Reports Generator</h1><p> Create custom analytics reports with your data </p></div> 
                        ...
                        <div className="row"> 
                            <div className="col-md-8"> 
                                ...
                                <div className="card">  
                                    ...
                                    <div className="card-body pt-0" > 
                                        ...
                                        <div className="d-flex justify-content-between align-items-start  w-100">
                                            ...
                                            <div className="flex-grow-1">
                                            <div className="d-flex align-items-center mb-2">
                                                <h6 className="fw-semibold mb-0 text-dark">Monthly Growth Summary
</h6>
                                                <span className="badge ms-2 px-3 py-1"
                                                style={{ background: "linear-gradient(to right, #f97316, #ea580c)", fontWeight:"600",fontSize:"12px" }}
                                                >
                                            ...
                                            <div className="d-flex flex-wrap gap-2">
                                                ...
                                                <span className="badge rounded-pill px-3 py-2 fw-semibold custom-hashtag-badge">Top Content
</span>
                                                <span className="badge rounded-pill px-3 py-2 fw-semibold custom-hashtag-badge">+1 more</span>
                                            </div>
                                            </div>
                                        ...
                                        <div className="d-flex justify-content-between align-items-start  w-100">
                                           ...
                                           Compare your performance against industry competitors
                                            ...
                                            <div className="d-flex flex-wrap gap-2">
                                                ...
                                                <span className="badge rounded-pill px-3 py-2 fw-semibold custom-hashtag-badge">Content Strategy
</span>
                                                <span className="badge rounded-pill px-3 py-2 fw-semibold custom-hashtag-badge">+1 more</span>
                                            </div>
                                            </div>
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body pt-0 p-4" > 
                                       <div className="d-flex gap-3 w-100 border-bottom pb-3"> 
                                        ...
                                        <div className="w-100"> <button className="btn btn-hover-effect rounded-3 btn-primary d-flex align-items-center  justify-content-center w-100 my-3"> 
                                        ...
                                        <div className="d-flex flex-column gap-3 mb-4 p-2"> 
                                            <div className="w-100">
                                                <div className="d-flex align-items-center justify-content-between w-100"> 
                                                    ...
                                                    <div class="d-inline-flex align-items-center rounded-pill green-badge  fw-semibold small px-3"> Ready </div>
                                                </div>
                                         ...
                                         <div className="d-flex flex-column gap-3 p-2"> 
                                            <div className="w-100">
                                                <div className="d-flex align-items-center w-100"> 
                                                    ...
                                                    </p> <span className="badge rounded-pill px-3 py-2 fw-semibold  bg-warning-subtle yellow-badge ms-2">
  Processing
</span>
