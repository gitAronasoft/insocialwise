...
export default function LinkedinAnalyticsDetailPage() {
  ...
  const handleSelectedPage = async(socialPage) => {
    ...
    await FetchPostsComments(socialPage);
  }
                  ...
                  <div className="page-title"> 
                    <div className="row" style={{ marginTop: "0px" }}>
                      <div className="col-md-5">
                        {/* <h3 className="">
                          <img className="me-2" src={`${process.env.PUBLIC_URL}/assets/images/analytics-ican/linkedin.png`} alt=""/>
                            LinkedIn Summary
                        </h3> */}
                    ...
                    <div>
                      <ul className="nav nav-tabs mb-4 gap-2" id="socialTabs" role="tablist">
                        <li className="nav-item" role="presentation">
                          <button className="nav-link active" id="linkedin-tab" data-bs-toggle="tab" data-bs-target="#Summary"
                            type="button" role="tab" aria-controls="linkedin" aria-selected="true">
                            Summary
                          </button>
                        </li>
                        <li className="nav-item" role="presentation">
                          <button className="nav-link" id="instagram-tab" data-bs-toggle="tab" data-bs-target="#Post"
                            type="button" role="tab" aria-controls="linkedin" aria-selected="false">
                            Post
                          </button>
                        </li>
                        <li className="nav-item" role="presentation">
                                ...
                                <div className="card-header-right-icon">
                                  <div className="dropdown icon-dropdown">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end" aria-labelledby="campaignDropdown">
                                      <a className="dropdown-item" style={{ cursor: "pointer" }} onClick={() => { PostsByType("publishedPost"); }} > Published </a>
                                      <a className="dropdown-item" style={{ cursor: "pointer" }} onClick={() => { PostsByType("draftPost"); }} > Draft </a>
                                      <a className="dropdown-item" style={{ cursor: "pointer" }} onClick={() => { PostsByType("scheduledPost"); }} > Scheduled </a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                    ...
                                    <div className='d-flex gap-2'>
                                      <div className='d-flex flex-column gap-2'>
                                        ...
                                        <div className='d-flex align-items-center justify-content-between w-100'>
                                          ...
                                          <div class="d-inline-flex align-items-center rounded-pill green-badge fw-semibold small"> Excellent </div>
                                        </div>
                                      </div>
                        ...
                        <div className='col-md-6'>
                          <div className='card'>
                            <div className='card-header card-no-border d-flex align-items-center justify-content-between'>
                              ...
                              <div>
                                <span class="primary-badge badge rounded-pill">1 post</span>
                              </div>
                            </div>
                            <div className='card-body pt-0'>
                              <div className='card'>
                                <div className='card-body'>
                                  ...
                                  <div className='d-flex align-items-center mt-3'>
                                    <span class="primary-badge badge rounded-pill">Scheduled</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-2 d-flex justify-content-end">
                            <button className="btn btn-primary w-auto" 
                              ...
                              <i class="fas fa-redo fa-spin"></i>{" "}Sync
                            </button>
                          </div>
                        </div>
                      )} */}
                      ...
                      <div className="row d-flex flex-wrap align-items-stretch my-3 gap-3 card ">
                        <div class="card-header d-flex justify-content-between align-items-center border-0">
                          <div class=" d-flex gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-square h-5 w-5 mr-2">
                              <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                            </svg>
                            <h5 class="h5-heading"> Comments </h5>
                          </div>
                          <div>
                            <span class="badge rounded-pill custom-blue-badge">{commentPosts.length} comments</span>
                          </div>
                        </div>
                        {Array.isArray(commentPosts) && commentPosts.length > 0 ? (
                          <>
                            {commentPosts.map((commentPost) => {
                              ...
                              const postPreview = commentPost?.UserPost?.content
                                ? `${commentPost.UserPost.content.split("#")[0]?.trim().split(" ").slice(0, 15).join(" ")}${
                                    commentPost.UserPost.content.split("#")[0]?.trim().split(" ").length > 15 ? "...": ""
                                  }`
                                : "";
                                  ...
                                  <div className="comments-card"> 
                                    <div className="d-flex justify-content-between">
                                      <div className="d-flex gap-3">
                                        ...
                                        <div>
                                          <div className='d-flex gap-2 align-items-center'>   
                                              <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=melo${randomNum}`}
                                      ...
                                      <div className="d-flex gap-1 p-3">
                                        ...
                                        <div className='comments-btn btn btn-sm btn-light' onClick={() => { setSelectCommentPost(commentPost); setCommentPostModal(true); }}> 
                                        ...
                                        <div className='comments-btn btn btn-sm btn-light' style={{ cursor: "pointer" }}
                                          onClick={() => {setSelectCommentPost(commentPost); setReplyingToComment(latestComment?.id); }}
                                        >
                                          <span> Reply </span>
                                        </div>
                                              ...
                                              <div className="row">
                                                ...
                                                <div className="col-xxl-2 col-xl-2 align-items-center">
                                                  <div className="d-flex justify-content-end">
                                                    <div className="d-flex">
                                                      <button type="button" className="btn btn-danger close" onClick={() => setCommentPostModal(false) }>
                                                        <span>&times;</span>
                                                      </button>
                                                    </div>
                                                  </div>
                                                ...
                                                <div className="d-flex" style={{ paddingRight: 10 }} >
                                                  <div class="dropdown hideArrow">
                                                    ...
                                                    <ul className="dropdown-menu">
                                                      <li>
                                                        <span class="dropdown-item" onClick={() => {handleEdit(selectedEvent.form_id)} } >
                          ...
                          <div className="preview-header">
                            ...
                            <div className="profile-info">
                              ...
                              <span>
                                ...
                                {console.log("PostViewData: ",postView)}
                              </span>
                            </div>
                          </div>
                          <div>
