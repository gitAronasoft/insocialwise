...
export default function SocialScoreComponent({ socialScores }) {
    ...
    const progress = Math.ceil(socialScores?.total_score) / 100;
                    ...
                    <div className="d-flex justify-content-center my-4">
                        <div className="position-relative" style={{ width: "150px", height: "150px" }}>
                            ...
                            <div className="position-absolute top-50 start-50 translate-middle text-center">
                                <div className="h2 fw-bold text-dark">{Math.ceil(socialScores?.total_score)}</div>
                    ...
                    <div className="row g-3 mb-4">
                        ...
                        <div className="col-12 col-sm-6">
                            <div className="p-3 rounded d-flex align-items-center shadow ">
                                ...
                                <div>
                                    <div className="fw-semibold">{socialScores?.total_engagement > 0 ? `+${socialScores?.total_engagement}` : `${socialScores?.total_engagement}`}%</div>
                        ...
                        <div className="col-12 col-sm-6">
                            <div className="p-3 rounded d-flex align-items-center shadow ">
                                ...
                                <div>
                                    <div className="fw-semibold">{socialScores?.total_shares > 0 ? `${socialScores?.total_shares}` : `${socialScores?.total_shares}`}</div>
                        ...
                        <div className="col-12 col-sm-6">
                            <div className="p-3 rounded d-flex align-items-center shadow ">
                                ...
                                <div>
                                    <div className="fw-semibold">{socialScores?.total_reach > 0 ? `${socialScores?.total_reach}` : `${socialScores?.total_reach}`}</div>
