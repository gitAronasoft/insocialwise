                    ...
                    <div className="row g-3 mb-4">
                        <div className="col-12 col-sm-6 ">
                            ...
                            <div className="p-3 rounded d-flex align-items-center shadow">
                                <div className="d-flex p-1 rounded-3 me-2" style={{ background: "linear-gradient(to right, #3b82f6, #8b5cf6)" }}>
                        ...
                        <div className="col-12 col-sm-6">
                            <div className="p-3 rounded d-flex align-items-center shadow ">
                                <div className="d-flex p-1 rounded-3 me-2" style={{ background: "linear-gradient(to right, #22c55e, #14b8a6)" }}>
                        ...
                        <div className="col-12 col-sm-6">
                            <div className="p-3 rounded d-flex align-items-center shadow ">
                                <div className="d-flex p-1 rounded-3 me-2" style={{ background: "linear-gradient(to right, #a855f7, #ec4899)" }}>
                        ...
                        <div className="col-12 col-sm-6">
                            <div className="p-3 rounded d-flex align-items-center shadow ">
                                <div className="d-flex p-1 rounded-3 me-2" style={{ background: "linear-gradient(to right, #f97316, #ef4444)" }}>
