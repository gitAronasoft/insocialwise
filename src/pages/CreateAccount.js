      ...
      if (firstName === '') {
        ...
        try {
          ...
          if(res.ok) { 
            ...
            localStorage.setItem('accountCreate', 'success');             
                    ...
                    <div className="form-group mb-0">
                      <div className="checkbox p-0">
                        <input 
                          ...
                          className={checkboxError ? 'border-danger' : ''}
                        />
                        <label className="text-muted" htmlFor="checkbox1">
                          Agree with <Link target='_blank' to="https://www.insocialwise.com/privacy-policy.html">Terms & conditions and privacy policy</Link>
                        </label>
                        {checkboxError && (
